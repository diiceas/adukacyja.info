...
(function ($) {
    ...
    */
    ...
    var addVariable = {
        ...
        proxy: { urlKey: 'processProxyUrl', title: options.addProxyTitle },
    };
    ...
    positionDesign.prototype = {
        ...
        initialize: function () {
            ...
            this.menuBar = new yardi.positionAnchor({
                ...
                onAddProxy: function () { self.addComponentDialog('proxy'); }
            });
   ...
   * Proxy content
   */
    var proxyContent = function (config) {
        proxyContent.superclass.constructor.call(this, config);
    };
    yardi.extend(proxyContent, content, {
        initialize: function () {
            proxyContent.superclass.initialize.call(this);
        }
    });
    content.register('proxy', proxyContent);
